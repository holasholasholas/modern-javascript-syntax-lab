...
const { make, model, horsepower, YOM } = car;
...
let uncontroversialPizzaToppings = [...morePizzaToppings];
...
const userProfile = { [propertyName]: 5 };
...
function twoParam(noun = "cat", adjective = "orange") {
...
lang = localLangConfig || "es";

console.log(`localLang is fr, lang is ${lang}`);
